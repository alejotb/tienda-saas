...
class _LoginPageWidgetState extends State<LoginPageWidget>
  ...
  Future<void> _handleLogin() async {
    if (_model.emailAddressTextController.text.trim().isEmpty ||
        _model.passwordTextController.text.trim().isEmpty) {
      return;
    }
            ...
            children: [
              Align(
                ...
                child: Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(
                    32.0,
                    MediaQuery.sizeOf(context).width >= 768.0 ? 24.0 : 0.0,
                    32.0,
                    16.0,
                  ),
                  child: Container(
                    width: double.infinity,
                    height: MediaQuery.sizeOf(context).width >= 768.0 ? 70.0 : 160.0,
              ...
              Align(
                ...
                child: Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(
                    0.0,
                    MediaQuery.sizeOf(context).width >= 768.0 ? 94.0 : 130.0,
                    0.0,
                    0.0,
                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            onTap: () => context.pushNamed('storeRegister'),
                            borderRadius: BorderRadius.circular(16.0),
                            child: Container(
                              constraints:
                                  const BoxConstraints(maxWidth: 570.0),
                              width: double.infinity,
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'Crea tu tienda online personalizada gratis',
                                          style: GoogleFonts.inter(
                                            fontSize: 12.0,
                                            color: FlutterFlowTheme.of(context)
                                                .secondaryText,

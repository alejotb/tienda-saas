...
import 'components/order_items_list.dart';
import 'components/apartado_payment_details.dart';
...
class _OrderHistoryDetailsWidgetState extends State<OrderHistoryDetailsWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.shippingAdress = functions
          .jsonToAddressList(widget.orderRef!.shippingAddress!)
          .firstOrNull;
      safeSetState(() {});
    });
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  OrderHeader(orderRef: widget.orderRef!),
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 4.0, 0.0, 8.0),
                                    child: Text(
                                      'Ordenado el:${dateTimeFormat("MMMEd", widget.orderRef?.createdAt)} at ${dateTimeFormat("jm", widget.orderRef?.createdAt)}',
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            font: GoogleFonts.inter(
                                  ...
                                  ShippingAddress(shippingAdress: _model.shippingAdress),
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 8.0, 0.0, 8.0),
                                    child: Text(
                                  ...
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 12.0, 0.0, 0.0),
                                    child: OrderItemsList(orderId: widget.orderRef?.id ?? ''),
                                  ),
                                  if (widget.orderRef?.status == 'apartado' || widget.orderRef?.status == 'expirado')
                                    Padding(
                                      padding: const EdgeInsets.only(top: 16.0),
                                      child: ApartadoPaymentDetails(
                                        pedidoId: widget.orderRef?.id ?? '',
                                        totalPedido: widget.orderRef?.totalPrice ?? 0.0,
                                      ),
                                    ),
                                ],
                              ),

...
import 'dropdown_account_guest_model.dart';
export 'dropdown_account_guest_model.dart';

class DropdownAccountGuestWidget extends StatefulWidget {
  const DropdownAccountGuestWidget({super.key});

  @override
  State<DropdownAccountGuestWidget> createState() =>
      _DropdownAccountGuestWidgetState();
}

class _DropdownAccountGuestWidgetState extends State<DropdownAccountGuestWidget>
    with TickerProviderStateMixin {
  late DropdownAccountGuestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DropdownAccountGuestModel());

...
class BaulPandoraSupabaseUser extends BaseAuthUser {
  BaulPandoraSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> baulPandoraSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = BaulPandoraSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}

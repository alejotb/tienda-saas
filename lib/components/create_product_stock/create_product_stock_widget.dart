...
import 'create_product_stock_model.dart';
export 'create_product_stock_model.dart';

class CreateProductStockWidget extends StatefulWidget {
  const CreateProductStockWidget({
    super.key,
    required this.guardarProducto,
  });

  final Future Function(ProductoStruct producto)? guardarProducto;

  @override
  State<CreateProductStockWidget> createState() =>
      _CreateProductStockWidgetState();
}

class _CreateProductStockWidgetState extends State<CreateProductStockWidget> {
  late CreateProductStockModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateProductStockModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.uuIdTemp = functions.generateRealUUID();
      safeSetState(() {});
    });
        ...
        Padding(
          ...
          child: FutureBuilder<List<UsuariosRow>>(
            ...
            builder: (context, snapshot) {
              ...
              List<UsuariosRow> productoExpandableUsuariosRowList =
                  snapshot.data!;

              final productoExpandableUsuariosRow =
                  productoExpandableUsuariosRowList.isNotEmpty
                      ? productoExpandableUsuariosRowList.first
                      : null;
              ...
              return Container(
                ...
                child: Stack(
                  children: [
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(12.0, 4.0, 8.0, 8.0),
                      child: Container(
                        width: double.infinity,
                        color: FlutterFlowTheme.of(context).secondaryBackground,
                          ...
                          child: ExpandablePanel(
                            header: Text(
                              valueOrDefault<String>(
                                _model.productoNuevo != null
                                    ? _model.productoNuevo?.nombre
                                    : 'Nuevo Producto',
                                'Nuevo Producto',
                              ),
                            ...
                            collapsed: Container(
                              ...
                              child: Text(
                                'Introduzca los datos del producto a continuación',
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                      font: GoogleFonts.inter(
                            ...
                            expanded: Column(
                              ...
                              children: [
                                    ...
                                    children: [
                                      ...
                                      Align(
                                        ...
                                        child: Stack(
                                          children: [
                                            Hero(
                                              tag: _model.images.elementAtOrNull(
                                                              _model
                                                                  .imagesIndex!) !=
                                                          null &&
                                                ...
                                                onTap: () async {
                                                  ...
                                                  if (selectedMedia != null &&
                                                    ...
                                                    try {
                                                      ...
                                                      _model.isDataUploading_uploadData24h =
                                                          false;
                                                    }
                                                    if (selectedUploadedFiles
                                                        ...
                                                        downloadUrls.length ==
                                                            selectedMedia
                                                                .length) {
                                                      safeSetState(() {
                                                        _model.uploadedLocalFile_uploadData24h =
                                                            selectedUploadedFiles
                                                                .first;
                                                        _model.uploadedFileUrl_uploadData24h =
                                                            downloadUrls.first;
                                                      });
                                                    } else {
                                                      safeSetState(() {});
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return Column(
                                      ...
                                      children: List.generate(
                                          columnCategoriasRowList.length,
                                          (columnIndex) {
                                        final columnCategoriasRow =
                                            columnCategoriasRowList[
                                                columnIndex];
                                        return Expanded(
                                          child: CategoriasGeneralesWidget(
                                            key: Key(
                                                'Keyzbv_${columnIndex}_of_${columnCategoriasRowList.length}'),
                                            categoriaGeneral:
                                                columnCategoriasRow,
                                            guardarCategorias:
                                                (categoriasSeleccionadas) async {
                                              _model.categorias2 =
                                              ...
                                              if (!_model
                                                  .categoriasSeleccionadas
                                                  .contains(_model.auxId)) {
                                                _model
                                                    .addToCategoriasSeleccionadas(
                                                        _model.auxId!);
                                                safeSetState(() {});
                                              }
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    await widget.guardarProducto?.call(
                                      ProductoStruct(
                                        nombre: _model

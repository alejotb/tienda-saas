...
import 'package:baul_pandora/auth/base_auth_user_provider.dart';

import 'package:baul_pandora/main.dart';
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => SearchResultsWidget(
            searchQuery: params.getParam('q', ParamType.String),
            categoryId: params.getParam('category', ParamType.String),
            minPrice: params.getParam('minPrice', ParamType.double),
            maxPrice: params.getParam('maxPrice', ParamType.double),
            sortBy: params.getParam('sortBy', ParamType.String),
            inStockOnly: params.getParam('inStockOnly', ParamType.bool),
          ),
        ),
        FFRoute(
          ...
          builder: (context, params) => ProductDetailsWidget(
            productRef: params.getParam<ProductosRow>(
              'productRef',
        ...
        FFRoute(
          name: ApartadoPaymentPage.routeName,
          path: ApartadoPaymentPage.routePath,
          builder: (context, params) => ApartadoPaymentPage(
            productIds: params.getParam<List<String>>(
              'productIds',
              ParamType.String,
              isList: true,
            ),
            productIdsJson: params.getParam<String>(
              'productIdsJson',
              ParamType.String,
            ),
            productDetailsJson: params.getParam<String>(
              'productDetailsJson',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          ...
          builder: (context, params) => OrderHistoryDetailsWidget(
            orderRef: params.getParam<PedidosRow>(
              'orderRef',
              ParamType.SupabaseRow,
            ),
          ),
        ...
        FFRoute(
          ...
          builder: (context, params) => CheckoutFullPageWidget(
            ...
            totalPagado: params.getParam<String>(
              'totalPagado',
              ParamType.String,
            ),
            bcvRate: params.getParam<String>(
              'bcvRate',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          ...
          builder: (context, params) {
            ...
            return params.isEmpty
                ? const NavBarPage(initialPage: 'adminPagos')
        ...
        FFRoute(
          ...
          builder: (context, params) {
            ...
            return params.isEmpty
                ? const NavBarPage(initialPage: 'adminDespachos')
                : const AdminDespachosPage();
          },
        ),
        FFRoute(
          ...
          builder: (context, params) {
            ...
            return params.isEmpty
                ? const NavBarPage(initialPage: 'adminInventario')
        ...
        FFRoute(
          name: ProductEditWidget.routeName,
          path: ProductEditWidget.routePath,
          builder: (context, params) => ProductEditWidget(
            productoRef: params.getParam<ProductosRow>(
              'productoRef',
              ParamType.SupabaseRow,
            ),
          ),
